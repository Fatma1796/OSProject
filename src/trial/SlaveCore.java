...
//    private int getOperandValue(char variable) {
//        if (variable == 'a') {
//            return masterCore.getProcessByAValue(memory.get('a')).getProcessId();
//        } else if (variable == 'b') {
//            return masterCore.getProcessByBValue(memory.get('b')).getProcessId();
//        } else {
//            return memory.get(variable);
//        }
//    }
...
//    private void performArithmetic(String operation, String[] args) {
//        Process process = masterCore.getProcessByAValue(memory.get('a'));
//        if (process == null) {
//            process = masterCore.getProcessByBValue(memory.get('b'));
//        }
//
//        if (process != null) {
//            int operand1 = memory.get(args[1].charAt(0));
...
//            }
//            memory.assign(args[0].charAt(0), result);
//            masterCore.updateValueMap(args[0].charAt(0), result, process);
//        } else {
//            System.out.println("Error: Process not found for the given values.");
//        }
//    }
